...
var dialogue = [
	...
	"Your goal is to cook: Tomato Pasta! easy, right!",
	...
	"Boiling Pasta + Hot Pasta Sauce = Tomato Pasta! That will be your final combination, so remember it well.",
	"How do you get pasta sauce? You must combine caramelised onions and canned tomato sauce. This is the only way, so lock in.",
	"How do you get pasta sauce? You must combine caramelised onions and canned tomato sauce. This is the only way, so lock in. (Yes, I'm telling you again)",
	...
	"You can also FLOOD your KITCHEN! with Oily or watery-based ingredients COMBINING with the WASHING MACHINE. So take a lot of care there.",
	"Floods aren't too bad though, and you can continue cooking despite them.",
